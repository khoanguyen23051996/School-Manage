            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-2" >
                        ...
                        <input type="text" class="form-control" name="student_name" value="{{ Request::get('student_name') }}" placeholder="Student Name">
                    </div>
                    ...
                    <div class="form-group col-md-2" >
                        ...
                        <a href="{{ route('teacher.attendance.report') }}" class="btn btn-success" style="margin-top: 32px; margin-left: 3px">Reset</a>
                    </div>
                </div>
            </div>
        </form>  
