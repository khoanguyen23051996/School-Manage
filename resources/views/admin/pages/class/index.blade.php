        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="form-group col-md-2" >
                    ...
                    <a href="{{ route('admin.class') }}" class="btn btn-success" style="margin-top: 32px; margin-left: 3px">Reset</a>
                </div>
            </div>
        </div>
    </form>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table class="table table-bordered">
                ...
                <tbody>
                  @forelse ($getRecord as $valueClass )
                  <tr>
                    <td>{{ $valueClass->id }}</td>
                    ...
                    <td>
                      ...
                      <a href="{{ url('admin/class/delete/'.$valueClass->id) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
                    </td>
                  </tr>   
                  @empty
                  <tr>
